 ...
 */
export function renderAlphabet(containerId, characters) {
 ...
 */
export function renderMemoryGrid(containerId, characters, pairCount = 6) {
    const container = document.getElementById(containerId);
    if (!container)
        return;
    ...
    container._memoryState = { pairs: tiles, lock: false, attempts: 0 };
